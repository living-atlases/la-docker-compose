...
ansible-playbook --private-key ~/.ssh/MyKey.pem -u ubuntu -i lademo-inventory.ini -i lademo-local-extras.ini -i lademo-local-passwords.ini $AI/ansible/collectory-by-type.yml --limit la-mh-1
ansible-playbook --private-key ~/.ssh/MyKey.pem -u ubuntu -i lademo-inventory.ini -i lademo-local-extras.ini -i lademo-local-passwords.ini $AI/ansible/biocache-hub-by-type.yml --limit la-mh-1
ansible-playbook --private-key ~/.ssh/MyKey.pem -u ubuntu -i lademo-inventory.ini -i lademo-local-extras.ini -i lademo-local-passwords.ini $AI/ansible/biocache-service-by-type.yml --limit la-mh-1
ansible-playbook --private-key ~/.ssh/MyKey.pem -u ubuntu -i lademo-inventory.ini -i lademo-local-extras.ini -i lademo-local-passwords.ini $AI/ansible/bie-hub-by-type.yml --limit la-mh-3
ansible-playbook --private-key ~/.ssh/MyKey.pem -u ubuntu -i lademo-inventory.ini -i lademo-local-extras.ini -i lademo-local-passwords.ini $AI/ansible/bie-index-by-type.yml --limit la-mh-3
ansible-playbook --private-key ~/.ssh/MyKey.pem -u ubuntu -i lademo-inventory.ini -i lademo-local-extras.ini -i lademo-local-passwords.ini $AI/ansible/image-service-by-type.yml --limit la-mh-2
ansible-playbook --private-key ~/.ssh/MyKey.pem -u ubuntu -i lademo-inventory.ini -i lademo-local-extras.ini -i lademo-local-passwords.ini $AI/ansible/species-list-by-type.yml --limit la-mh-1
ansible-playbook --private-key ~/.ssh/MyKey.pem -u ubuntu -i lademo-inventory.ini -i lademo-local-extras.ini -i lademo-local-passwords.ini $AI/ansible/regions-by-type.yml --limit la-mh-3
ansible-playbook --private-key ~/.ssh/MyKey.pem -u ubuntu -i lademo-inventory.ini -i lademo-local-extras.ini -i lademo-local-passwords.ini $AI/ansible/logger-service-by-type.yml --limit la-mh-1
ansible-playbook --private-key ~/.ssh/MyKey.pem -u ubuntu -i lademo-inventory.ini -i lademo-local-extras.ini -i lademo-local-passwords.ini $AI/ansible/solrcloud-by-type.yml --limit la-mh-2
ansible-playbook --private-key ~/.ssh/MyKey.pem -u ubuntu -i lademo-inventory.ini -i lademo-local-extras.ini -i lademo-local-passwords.ini $AI/ansible/auth-by-type.yml --limit la-mh-1
ansible-playbook --private-key ~/.ssh/MyKey.pem -u ubuntu -i lademo-inventory.ini -i lademo-local-extras.ini -i lademo-local-passwords.ini $AI/ansible/spatial-by-type.yml --limit la-mh-2
ansible-playbook --private-key ~/.ssh/MyKey.pem -u ubuntu -i lademo-inventory.ini -i lademo-local-extras.ini -i lademo-local-passwords.ini $AI/ansible/alerts-standalone.yml --limit la-mh-1
ansible-playbook --private-key ~/.ssh/MyKey.pem -u ubuntu -i lademo-inventory.ini -i lademo-local-extras.ini -i lademo-local-passwords.ini $AI/ansible/doi-service-standalone.yml --limit la-mh-2
ansible-playbook --private-key ~/.ssh/MyKey.pem -u ubuntu -i lademo-inventory.ini -i lademo-local-extras.ini -i lademo-local-passwords.ini $AI/ansible/sds.yml --limit la-mh-3
ansible-playbook --private-key ~/.ssh/MyKey.pem -u ubuntu -i lademo-inventory.ini -i lademo-local-extras.ini -i lademo-local-passwords.ini $AI/ansible/pipelines.yml --limit la-mh-3
ansible-playbook --private-key ~/.ssh/MyKey.pem -u ubuntu -i lademo-inventory.ini -i lademo-local-extras.ini -i lademo-local-passwords.ini $AI/ansible/data_quality_filter_service.yml --limit la-mh-2
ansible-playbook --private-key ~/.ssh/MyKey.pem -u ubuntu -i lademo-inventory.ini -i lademo-local-extras.ini -i lademo-local-passwords.ini $AI/ansible/namematching-service-by-type.yml --limit la-mh-3
ansible-playbook --private-key ~/.ssh/MyKey.pem -u ubuntu -i lademo-inventory.ini -i lademo-local-extras.ini -i lademo-local-passwords.ini $AI/ansible/sensitive-data-service-by-type.yml --limit la-mh-3
ansible-playbook --private-key ~/.ssh/MyKey.pem -u ubuntu -i lademo-inventory.ini -i lademo-local-extras.ini -i lademo-local-passwords.ini $AI/ansible/branding.yml --limit la-mh-1
ansible-playbook --private-key ~/.ssh/MyKey.pem -u ubuntu -i lademo-inventory.ini -i lademo-local-extras.ini -i lademo-local-passwords.ini $AI/ansible/docker-compose.yml --limit la-mh-1,la-mh-2,la-mh-3
ansible-playbook --private-key ~/.ssh/MyKey.pem -u ubuntu -i lademo-inventory.ini -i lademo-local-extras.ini -i lademo-local-passwords.ini $AI/ansible/gatus.yml --limit la-mh-3
ansible-playbook --private-key ~/.ssh/MyKey.pem -u ubuntu -i lademo-inventory.ini -i lademo-local-extras.ini -i lademo-local-passwords.ini $AI/ansible/portainer.yml --limit la-mh-3
ansible-playbook --private-key ~/.ssh/MyKey.pem -u ubuntu -i lademo-inventory.ini -i lademo-local-extras.ini -i lademo-local-passwords.ini $AI/ansible/cassandra-docker.yml --limit la-mh-3
```
